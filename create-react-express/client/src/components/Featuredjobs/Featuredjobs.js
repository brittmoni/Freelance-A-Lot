...
const Featuredjobs = props =>
    <div className="container">
        <div className="featured">
            ...
            <div className="row">
                ...
                <div className="col-md-3">
                    <img src="https://i.ibb.co/Htk48WM/frame-4.png" alt="fullstack" width="100" height="100"></img>
                </div>
            </div>
    ...
    $150 per hour (fixed price)</p>
           ...
           <div className="col-md-3">
                ...
                <div className="col-md-3">
                <img src="https://i.ibb.co/9pgvmMY/frame-5.png" alt="webdesigner" width="100" height="100"></img>
                </div>
            </div>
                <br></br>
                {/* -------JOB 3 section ----------- */}
...
CSS</p>
                    ...
                    <div className="col-md-3">
                        <img src="https://i.ibb.co/Ky7z2P0/frame-7.png" alt="frontenddev" width="100" height="100"></img>
                    </div>
                </div>
            </div>
        </div>
